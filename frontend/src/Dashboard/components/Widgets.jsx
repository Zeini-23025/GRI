      ...
      <table className="min-w-full bg-white shadow-md rounded-lg">
        <thead>
          <tr className="bg-gray-100 text-gray-600 uppercase text-sm leading-normal">
            ...
            <th className="py-3 px-6 text-left">Return Value</th>
            <th className="py-3 px-6 text-left">Bounce Rate</th>
          </tr>
        </thead>
        <tbody className="text-gray-600 text-sm font-light">
          {data.map((row, index) => (
            <tr key={index} className="border-b border-gray-200 hover:bg-gray-100">
              <td className="py-3 px-6 text-left">{row.pageName}</td>
              <td className="py-3 px-6 text-left">{row.views}</td>
              <td className="py-3 px-6 text-left">{row.returnValue}</td>
              <td className="py-3 px-6 text-left">{row.bounceRate}</td>
            </tr>
          ))}
        </tbody>
      </table>
